  ...
  return (
    <section className="relative isolate overflow-hidden px-4 pb-8 pt-16 md:px-8 md:pt-28">
      <div
        ...
        style={{ background: 'radial-gradient(circle, rgba(122,92,255,0.1), transparent 70%)' }}
        aria-hidden
      />
      <div
        ...
        <div className="grid gap-12 lg:grid-cols-[auto_1fr] lg:items-start lg:gap-24">
          ...
          <div className="hidden flex-col gap-10 lg:flex lg:pt-2">
            <div className="relative select-none">
              <p
                ...
                style={{ fontSize: 'clamp(5.5rem, 11vw, 8.5rem)', opacity: 0.04 }}
                aria-hidden
              >
                SDG
              </p>
              <div className="absolute inset-x-0 bottom-2">
                <p className="font-heading text-xl font-bold text-text">SDG Print</p>
            ...
            <div className="space-y-5">
              <div>
                ...
                <p className="mt-1 font-heading text-5xl font-bold text-text">48h</p>
              </div>
              <div>
                <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-muted/60">
                  Locație
                </p>
                <p className="mt-1 font-medium text-muted">Timișoara, România</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Link href="/contact" className="btn-primary">Contactează-ne</Link>
            ...
            <div className="mt-12 grid grid-cols-2 gap-8 sm:grid-cols-4">
              {stats.map((stat) => (
                <div key={stat.label}>
                  <p className="font-heading text-3xl font-bold text-text">{stat.display}</p>
