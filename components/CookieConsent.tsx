...
export const CookieConsent = () => {
  ...
  return (
    <div
      ...
      className="fixed bottom-0 left-0 right-0 z-[70] border-t border-slate-700/80 bg-bg/95 backdrop-blur-md"
    >
      <div className="mx-auto flex max-w-7xl flex-col gap-4 px-4 py-5 sm:flex-row sm:items-center sm:justify-between sm:gap-6 md:px-8">
        <div className="flex-1">
          ...
          <p className="mt-1 text-xs leading-relaxed text-muted">
            ...
            cookie-uri de analiză pentru a-l îmbunătăți. Nu vindem date personale.{' '}
